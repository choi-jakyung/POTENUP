      ...
      >
        ...
        <footer style={{ 
          ...
          <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
            <a href="https://www.instagram.com/wantedjobs.kr/" target="_blank" rel="noopener noreferrer" style={{ color: '#999', textDecoration: 'none' }}>
            ...
            <a href="https://www.youtube.com/@ch.wanted" target="_blank" rel="noopener noreferrer" style={{ color: '#999', textDecoration: 'none' }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
