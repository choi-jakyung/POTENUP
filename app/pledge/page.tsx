    ...
    <main style={{ background: '#fff', color: '#000', minHeight: '100vh', padding: '48px 24px' }}>
      <article ref={articleRef} style={{ maxWidth: 860, margin: '0 auto', fontSize: 14, lineHeight: 1.9 }}>
        ...
        <section style={{ marginTop: 40 }}>
          ...
          {/* 교육명 아코디언 */}
          <div style={{ marginBottom: 20, position: 'relative' }} data-course-dropdown>
            <label style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <span style={{ minWidth: 80, fontSize: 14 }}>교육명 :</span>
          ...
          <div style={{ marginBottom: 20 }}>
            <label style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <span style={{ minWidth: 80, fontSize: 14 }}>주&nbsp;&nbsp;소 :</span>
              <div style={{ flex: 1 }}>
                <input
                  type="text"
                  value={address}
