...
export default function ProjectConsentPage() {
  ...
  return (
    <main style={{ background: '#fff', color: '#000', minHeight: '100vh', padding: '48px 24px' }}>
      <article style={{ maxWidth: 860, margin: '0 auto', fontSize: 14, lineHeight: 1.9 }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 'bold', color: '#333', marginBottom: 40, textAlign: 'center' }}>프로젝트 추가 편성 계획 안내 및 동의서</h1>
        <p>프로젝트 추가 편성 계획 안내 및 동의서 내용이 여기에 들어갑니다.</p>
